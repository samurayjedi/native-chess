    ...
    <Svg {...props} viewBox="0 0 56 56">
      <G>
        <Path
          ...
          d="M40.5,56h-24c-1.105,0-2-0.895-2-2v0c0-1.105,0.895-2,2-2h24c1.105,0,2,0.895,2,2v0
            C42.5,55.105,41.605,56,40.5,56z"
        />
        <Path
          fill={variant === 'black' ? '#333' : '#E5B55B'}
          d="M34.614,30.685c-0.256,0-0.512-0.098-0.707-0.293c-0.391-0.391-0.391-1.023,0-1.414l6.185-6.185
        ...
        <Path
          ...
          d="M38.855,30.214l-4.948,4.947c-0.391,0.391-0.391,1.023,0,1.414c0.195,0.195,0.451,0.293,0.707,0.293
        ...
        <Path
          fill={variant === 'black' ? '#666' : '#F9C97D'}
          d="M41.506,22.793c-0.391-0.391-1.023-0.391-1.414,0l-6.185,6.185c-0.391,0.391-0.391,1.023,0,1.414
        ...
        <Path
          fill={variant === 'black' ? '#666' : '#F9C97D'}
          d="M40.092,16.608l-6.185,6.185c-0.391,0.391-0.391,1.023,0,1.414c0.195,0.195,0.451,0.293,0.707,0.293
        ...
        <Path
          fill={variant === 'black' ? '#666' : '#F9C97D'}
          d="M38.855,10.425l-3.711,3.71c-0.391,0.391-0.391,1.023,0,1.414c0.195,0.195,0.451,0.293,0.707,0.293
        ...
        <Path
          ...
          d="M36.5,52h-16c-1.657,0-3-1.343-3-3v0c0-1.657,1.343-3,3-3h16c1.657,0,3,1.343,3,3v0
